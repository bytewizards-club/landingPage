...
export const caseStudy = {
  ...
  testimonial: {
    ...
    content:
      'Our team consists of experienced engineers and algorithm developers who excel in delivering innovative solutions. We are committed to pushing the boundaries of technology to create impactful products and services. With a blend of expertise and creativity, we strive to meet the dynamic needs of our clients and the ever-evolving tech landscape.',
  },
}
